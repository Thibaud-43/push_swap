...
void		push_min_or_max_in_a5(t_list **a, t_list **b, t_bigsort *bs)
{
	if (bs->min_or_max)
	{
		pa(a, b);
...
void		push_min_or_max_in_a4(t_list **a, t_list **b, t_bigsort *bs)
{
...
void		push_min_or_max_in_a3(t_list **a, t_list **b, t_bigsort *bs)
{
...
void		push_min_or_max_in_a2(t_list **a, t_list **b, t_bigsort *bs)
{
...
void		push_min_or_max_in_a(t_list **a, t_list **b, t_bigsort *bs)
{
	...
	while (bs->len_b && (*b))
	{
		push_min_or_max_in_a3(a, b, bs);
		push_min_or_max_in_a2(a, b, bs);
		push_min_or_max_in_a4(a, b, bs);
		push_min_or_max_in_a5(a, b, bs);
	}
	while (bs->top--)
	{
		ra(a, b);
